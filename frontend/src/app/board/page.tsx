...
export default function Board(){
    ...
    const [epd,setEpd]=useState("rnbqkbnr/pppppppp/00000000/0000n000/00P0P000/00000000/PPPp0PPp/RNBQKBNR".split("/").reverse().map((row)=>row.split("")));
    const [epd_display,setEpdDisplay]=useState("00000000/00000000/00.000.0/00000000/00-000.0/000.0.00/00000000/00000000".split("/").reverse().map((row)=>row.split("")));
