use std::cmp;
pub fn all_valid_queen_moves(epd: String, move_str: String) -> String {
...
// bishop valid moves
pub fn all_valid_bishop_moves(epd: String, move_str: String) -> String {
let epd: Vec<&str> = epd.split('/').collect();
let mut epd_mod: Vec<Vec<char>> = epd.iter().map(|&row| row.chars().collect()).collect();
let mut epd_res: Vec<Vec<char>> = vec![vec!['0'; 8]; 8];
...
pub fn all_valid_knight_moves(epd: String, move_str: String) -> String {
// here i have split the string by / then at each row there are characters that correspond to the pieces on the corresponding board square
let epd: Vec<&str> = epd.split('/').collect();
let mut epd_mod: Vec<Vec<char>> = epd.iter().map(|&row| row.chars().collect()).collect();
let mut epd_res: Vec<Vec<char>> = vec![vec!['0'; 8]; 8];
...
pub fn all_valid_pawn_moves(epd: String, move_str: String) -> String {
let epd: Vec<&str> = epd.split('/').collect();
let mut epd_mod: Vec<Vec<char>> = epd.iter().map(|&row| row.chars().collect()).collect();
let mut epd_res: Vec<Vec<char>> = vec![vec!['0'; 8]; 8];
...
pub fn all_valid_king_moves(epd: String, move_str: String) -> String {
let epd: Vec<&str> = epd.split('/').collect();
let mut epd_mod: Vec<Vec<char>> = epd.iter().map(|&row| row.chars().collect()).collect();
let mut epd_res: Vec<Vec<char>> = vec![vec!['0'; 8]; 8];
...
pub fn all_valid_rook_moves(epd:String,move_str:String)->String{
// here i have split the string by / then at each row there are characters that correspond to the pieces on the corresponding board square
let epd: Vec<&str> = epd.split('/').collect();
let mut epd_mod: Vec<Vec<char>> = epd.iter().map(|&row| row.chars().collect()).collect();
let mut epd_res: Vec<Vec<char>> = vec![vec!['0'; 8]; 8];
